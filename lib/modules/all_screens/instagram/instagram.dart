...
class _InstagramState extends State<Instagram> {
  ...
  getData() async {
    ...
    controller.getInstagramUsernameList = controller.setInstagramUsernameList.toSet().toList();
    setState(() {
      controller.setInstagramUsernameList.join("");
      controller.getInstagramUsernameList.join("");
    });
  }
          ...
          children: [
            Column(
              children: [
                ...
                Expanded(
                    child: controller.getInstagramUsernameList.isNotEmpty
                        ? ListView.builder(
                            controller:
